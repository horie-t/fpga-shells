...
class Nexys4DDRMIGIODDR(depth : BigInt) extends GenericParameterizedBundle(depth) {
  require((depth<=0x100000000L),"Nexys4DDRMIGIODDR supports upto 4GB depth configuraton")
...
{
  // TODO:horie change memory size
  require((depth<=0x100000000L),"nexys4ddrmig supports upto 4GB depth configuraton")
  override def desiredName = if(depth<=0x40000000) "nexys4ddrmig1gb" else "nexys4ddrmig4gb"
  ...
  val io = new Nexys4DDRMIGIODDR(depth) with Nexys4DDRMIGIOClocksReset {
    ...
    val s_axi_awaddr          = Bits(INPUT,if(depth<=0x40000000) 30 else 32) // TODO:horie
    ...
    val s_axi_araddr          = Bits(INPUT,if(depth<=0x40000000) 30 else 32) // TODO:horie
  ...
  // TODO:horie change text and size
  val nexys4ddrmig1gbprj = """ {<?xml version='1.0' encoding='UTF-8'?>
...
<Project NoOfControllers="1" >
  ...
  // TODO:horie remove?
   val nexys4ddrmig4gbprj = """ {<?xml version='1.0' encoding='UTF-8'?>
<!-- IMPORTANT: This is an internal file that has been generated by the MIG software. Any direct editing or changes made to this file may result in unpredictable behavior or data corruption. It is strongly advised that users do not edit the contents of this file. Re-run the MIG GUI with the required settings if any of the options provided below need to be altered. -->
<Project NoOfControllers="1" >
  ...
  val migprj = if(depth<=0x40000000) nexys4ddrmig1gbprj else nexys4ddrmig4gbprj
  val migprjname =  if(depth<=0x40000000) """{/nexys4ddrmig1gb.prj}""" else """{/nexys4ddrmig4gb.prj}"""
  val modulename =  if(depth<=0x40000000)  """nexys4ddrmig1gb""" else """nexys4ddrmig4gb"""
